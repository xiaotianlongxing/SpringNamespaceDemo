...
public class ShardingDataSource extends AbstractDataSourceAdapter {
    ...
    private static ShardingContext shardingContextTmp;
    ...
    public ShardingDataSource(final Map<String, DataSource> dataSourceMap, final ShardingRule shardingRule, final Map<String, Object> configMap, final Properties props) throws SQLException {
        ...
        shardingContextTmp = shardingContext;
    }
    ...
    public final ShardingConnection getConnection() {
        if(shardingContextTmp != null){
        	shardingContext = shardingContextTmp;
        	shardingContextTmp.close();
        	shardingContextTmp = null;
        }
